    ...
    def get_parser_class(
        ...
        *,
        ...
        if file_type is None:
            ...
            normalized_file_type = self._normalize_file_type(engine_or_file_type)
        else:
            requested_engine = self._normalize_engine(engine_or_file_type)
            normalized_file_type = self._normalize_file_type(file_type)
        ...
        raise KeyError(
            ...
            f"Builtin supported: {self.list_supported()}"
        )
